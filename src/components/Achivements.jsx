    ...
    <div className='bg-black pt-30 md:px-70'>
       ...
       <div className=' mt-10'>
        <div className='flex gap-5'>
            ...
            <div className='border px-9 py-9 rounded-lg border-gray-200'>
            ...
            <div className='border px-9 py-9 rounded-lg border-gray-300'>
            ...
            <div className='border px-9 py-9 rounded-lg border-gray-200'>
                <h1 className='text-white text-2xl font-medium'>Industry Recognition</h1>
                <p className='text-gray-400 text-sm'>We've earned the respect of our peers and industry leaders, with accolades and awards that reflect our commitment to excellence.</p>
            </div>
        </div>
        </div>
    </div>
