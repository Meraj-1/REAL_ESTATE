  ...
  return (
    <div className="bg-[#1A1A1A] flex flex-col pt-14 text-white">
      ...
      <div className='grid grid-cols-4 bg-black py-3 px-3 mt-10 gap-3 text-white'>
        <div className='flex bg-[#1A1A1A] rounded-lg flex-col p-15 justify-center items-center text-center  gap-4'>
          <img className='h-18' src={assets.Oprion1} alt="" />
          <p className='text-md'>Find Your Dream Home</p>
        </div>
        <div className='flex bg-[#1A1A1A] rounded-lg  flex-col p-8 justify-center items-center text-center px-10 gap-4'>
          <img className='h-18' src={assets.Option2} alt="" />
          <p className='text-md'>Unlock Property Value</p>
        </div>
        <div className='flex bg-[#1A1A1A] rounded-lg flex-col p-8 justify-center items-center text-center px-10 gap-4'>
          <img className='h-18' src={assets.Option3} alt="" />
          <p className='text-md'>Effortless Property Management</p>
        </div>
        <div className='flex bg-[#1A1A1A] rounded-lg flex-col p-8 justify-center items-center text-center px-10 gap-4'>
          <img className='h-18' src={assets.Option4} alt="" />
          <p className='text-md'>Smart Investments, Informed Decisions</p>
        </div>
      </div>
    </div>
  )
